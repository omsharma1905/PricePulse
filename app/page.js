...
import PricePulse from "../public/pricePulse.png"
  ...
  const FEATURES = [
    {
      ...
      description:
        "PricePulse extracts prices in seconds, handling JavaScript and dynamic content",
    },
    {
      icon: Shield,
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
            Paste a product link. We’ll stare at the price so you don’t have to.
          </p>
